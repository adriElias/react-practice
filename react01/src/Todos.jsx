...
// const papelera = <svg xmlns="http://www.w3.org/2000/svg" width="24"
...
// const bolt = <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
//     viewBox="0 0 24 24" fill="none" stroke="red" strokeWidth="2"
//     strokeLinecap="round" strokeLinejoin="round"
//     className="icon icon-tabler icons-tabler-outline icon-tabler-bolt">
//     <path stroke="none" d="M0 0h24v24H0z" fill="none" />
//     <path d="M13 3l0 7l6 0l-8 11l0 -7l-6 0l8 -11" /></svg>
...
//     const filas = listado
//         .filter(x => mostrarCompletadas || x.completed == false)
//         .map(todo => {
//             return (
//                 <tr key={todo.id}>
//                     <td>{todo.id}</td>
...
//             />
//             <br />
//             <Button variant="primary" onClick={cargarDatos}>Cargar</Button>
//             <br />
